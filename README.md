...
Like Internal_Medicine coming 112 times ,Family Medicine coming 93 times,Cardiology coming 60 times,and Neurology coming 56 times etc. 
ot used Pretrained Hugging face model (like BioBert) or heavy transformer model  due to time complexity in running time streaming data which takes time and Space complexity like billion of parameters (MBs in size of file)
